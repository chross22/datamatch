...
All five return the same `sf` shape, so
...
[`matchData()`](https://chross22.github.io/datamatch/reference/matchData.md)
chains. Each call adds that product’s columns and leaves the row count
alone, so the order does not matter and nothing needs combining by hand.
...
never quietly reconciles those grids on your behalf.
[`matchData()`](https://chross22.github.io/datamatch/reference/matchData.md)
...
renders either dictionary as a pipe table, for pasting into
documentation:
...
Pass those names to
[`accessEnvDat()`](https://chross22.github.io/datamatch/reference/accessEnvDat.md)
and the result comes back with them as column names, rather than the
Copernicus codes:
...
seasons and latitudes where cloud is persistent.
[`fill_satellite_gaps()`](https://chross22.github.io/datamatch/reference/fill_satellite_gaps.md)
substitutes the model equivalent where the satellite saw nothing, and
records the source of every value.

**[`accessEnvDat()`](https://chross22.github.io/datamatch/reference/accessEnvDat.md)
fetches one dataset per call**, on that dataset’s native grid. It does
not resample, and it refuses to fetch variables from different datasets
together rather than quietly reconciling them.

**[`matchData()`](https://chross22.github.io/datamatch/reference/matchData.md)
is resolution-agnostic.** Observations match to the nearest
environmental cell. So a 0.083-degree and a 0.25-degree product both
attach correctly to the same stations. The observation simply lands in a
bigger or smaller cell.
...
ships two NECOFS archives, and the second is **not** a continuation of
the first:
...
**The two
[`accessEnvDat()`](https://chross22.github.io/datamatch/reference/accessEnvDat.md)
calls are not an inconvenience to work around.** `SST` and `CHL` live in
different datasets on different grids: 0.083° for the physics, 0.25° for
the biogeochemistry. The package refuses to fetch them together rather
than quietly reconciling two grids on your behalf.
[`matchData()`](https://chross22.github.io/datamatch/reference/matchData.md)
then handles both correctly, because it matches to the nearest cell
whatever its size.

**[`matchData()`](https://chross22.github.io/datamatch/reference/matchData.md)
chains.** Its output is an `sf` object with the same time columns it
consumed. So you can feed it back in for the next dataset, and the row
count is preserved. Order does not matter.

**The joins fail in different ways.**
[`matchData()`](https://chross22.github.io/datamatch/reference/matchData.md)
...
|  |  |
|----|----|
| [`accessEnvDat()`](https://chross22.github.io/datamatch/reference/accessEnvDat.md) | Copernicus Marine: physics, biogeochemistry, ocean colour, wind |
| [`accessFVCOM()`](https://chross22.github.io/datamatch/reference/accessFVCOM.md) | FVCOM / NECOFS on an unstructured mesh |
| [`accessHYCOM()`](https://chross22.github.io/datamatch/reference/accessHYCOM.md) | HYCOM GOFS 3.1, with sea-floor fields |
| [`accessCCMP()`](https://chross22.github.io/datamatch/reference/accessCCMP.md) | CCMP six-hourly surface winds |
| [`accessERDDAP()`](https://chross22.github.io/datamatch/reference/accessERDDAP.md) | MUR SST and VIIRS chlorophyll, via NOAA ERDDAP |

**Matching**

|  |  |
|----|----|
| [`matchData()`](https://chross22.github.io/datamatch/reference/matchData.md) | the spatiotemporal nearest-feature join |
| [`source_of()`](https://chross22.github.io/datamatch/reference/source_of.md) | which source and archive an object came from |
| [`write_eml()`](https://chross22.github.io/datamatch/reference/write_eml.md) | EML metadata for a matched table, for depositing it |
| [`covariate_columns()`](https://chross22.github.io/datamatch/reference/covariate_columns.md) | which columns are data rather than time or provenance |

**Resampling and gap filling**

|  |  |
|----|----|
| [`upscale_grid()`](https://chross22.github.io/datamatch/reference/upscale_grid.md), [`downscale_grid()`](https://chross22.github.io/datamatch/reference/downscale_grid.md) | between spatial grids |
| [`upscale_time()`](https://chross22.github.io/datamatch/reference/upscale_time.md), [`downscale_time()`](https://chross22.github.io/datamatch/reference/downscale_time.md) | between time steps |
| [`fill_satellite_gaps()`](https://chross22.github.io/datamatch/reference/fill_satellite_gaps.md) | substitute a model where the satellite saw nothing |
| [`grid_resolution()`](https://chross22.github.io/datamatch/reference/grid_resolution.md) | the spacing of a grid, for deciding which way to go |

**Plotting**

|  |  |
|----|----|
| [`plot_env()`](https://chross22.github.io/datamatch/reference/plot_env.md) | a map of one variable at one time step |
| [`plot_coverage()`](https://chross22.github.io/datamatch/reference/plot_coverage.md) | the fraction of cells carrying a value, per step |
| [`plot_series()`](https://chross22.github.io/datamatch/reference/plot_series.md) | the study area reduced to a series |
| [`plot_matched()`](https://chross22.github.io/datamatch/reference/plot_matched.md) | what the join produced, including what missed |

**Other covariates**

|  |  |
|----|----|
| [`fetch_bathymetry()`](https://chross22.github.io/datamatch/reference/fetch_bathymetry.md), [`attach_bathymetry()`](https://chross22.github.io/datamatch/reference/attach_bathymetry.md), [`bathymetry_variables()`](https://chross22.github.io/datamatch/reference/bathymetry_variables.md) | seafloor terrain |
| [`fetch_climate_index()`](https://chross22.github.io/datamatch/reference/fetch_climate_index.md), [`attach_climate_index()`](https://chross22.github.io/datamatch/reference/attach_climate_index.md), [`climate_indices()`](https://chross22.github.io/datamatch/reference/climate_indices.md), [`index_dictionary()`](https://chross22.github.io/datamatch/reference/index_dictionary.md) | basin-scale indices |
| [`climate_index_status()`](https://chross22.github.io/datamatch/reference/climate_index_status.md), [`refresh_climate_index()`](https://chross22.github.io/datamatch/reference/refresh_climate_index.md) | what is cached, and forcing a re-fetch |
...
|  |  |
|----|----|
| [`variable_dictionary()`](https://chross22.github.io/datamatch/reference/variable_dictionary.md), [`copernicus_variables()`](https://chross22.github.io/datamatch/reference/copernicus_variables.md), [`variable_dataset()`](https://chross22.github.io/datamatch/reference/variable_dataset.md), [`forecast_variables()`](https://chross22.github.io/datamatch/reference/forecast_variables.md), [`product_url()`](https://chross22.github.io/datamatch/reference/product_url.md) | Copernicus |
| [`fvcom_variables()`](https://chross22.github.io/datamatch/reference/fvcom_variables.md), [`fvcom_dictionary()`](https://chross22.github.io/datamatch/reference/fvcom_dictionary.md), [`fvcom_archives()`](https://chross22.github.io/datamatch/reference/fvcom_archives.md), [`fvcom_archive()`](https://chross22.github.io/datamatch/reference/fvcom_archive.md) | FVCOM |
| [`hycom_variables()`](https://chross22.github.io/datamatch/reference/hycom_variables.md), [`hycom_dictionary()`](https://chross22.github.io/datamatch/reference/hycom_dictionary.md), [`hycom_archives()`](https://chross22.github.io/datamatch/reference/hycom_archives.md), [`hycom_covering()`](https://chross22.github.io/datamatch/reference/hycom_covering.md) | HYCOM |
| [`ccmp_variables()`](https://chross22.github.io/datamatch/reference/ccmp_variables.md), [`ccmp_dictionary()`](https://chross22.github.io/datamatch/reference/ccmp_dictionary.md), [`ccmp_versions()`](https://chross22.github.io/datamatch/reference/ccmp_versions.md) | CCMP |
| [`erddap_datasets()`](https://chross22.github.io/datamatch/reference/erddap_datasets.md), [`erddap_dictionary()`](https://chross22.github.io/datamatch/reference/erddap_dictionary.md), [`erddap_dataset()`](https://chross22.github.io/datamatch/reference/erddap_dataset.md) | ERDDAP |
| [`as_markdown()`](https://chross22.github.io/datamatch/reference/as_markdown.md) | render any dictionary as a pipe table |
...
are the escape hatches — the first two reach any endpoint the package
does not ship, the third says which HYCOM archive holds a given date.
...
[`matchData()`](https://chross22.github.io/datamatch/reference/matchData.md),
as in [One call per product](#one-call-per-product).
...
[`index_dictionary()`](https://chross22.github.io/datamatch/reference/index_dictionary.md)
carries the references for the indices at runtime, and
[`variable_dictionary()`](https://chross22.github.io/datamatch/reference/variable_dictionary.md)
links to each Copernicus product page.
...
Each is somebody else’s work, and
[`fvcom_archives()`](https://chross22.github.io/datamatch/reference/fvcom_archives.md),
...
carry these references at runtime:
...
References section above says which, and each function’s
[`?help`](https://rdrr.io/r/utils/help.html) repeats it.
