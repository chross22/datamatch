...
- **NOAA CEFI / MOM6-COBALT-NWA12** — Ross AC, Stock CA, Adcroft A, Curchitser
  ...
  *Geoscientific Model Development* **16**:6943–6985.
  ...
  Credit the NOAA Physical Sciences Laboratory CEFI data portal as the
  distributor, and **say which release** — `source_of()` records it, as
...
- **NASA OB.DAAC** — cite the mission whose data you used, and credit the NASA
  Ocean Biology Processing Group as the producer along with the reprocessing
  version. `obdaac_sensors()` carries each of these at runtime, and
