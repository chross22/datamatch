...
- [`index_dictionary()`](https://camilleross.org/datamatch/reference/index_dictionary.md)
  [`print(`*`<datamatch_index_dictionary>`*`)`](https://camilleross.org/datamatch/reference/index_dictionary.md)
...
- [`climate_index_status()`](https://camilleross.org/datamatch/reference/climate_index_status.md)
  [`print(`*`<datamatch_index_status>`*`)`](https://camilleross.org/datamatch/reference/climate_index_status.md)
