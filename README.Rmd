...
**How to read the rest of this.** [Quick start](#quick-start) and [Variable
names](#variable-names) use Copernicus throughout, because it has the widest
variable list and the setup everything else builds on — but nearly all of it
(matching, resampling, plotting, the time-step rules) applies to every source.
The other four get their own sections under [The five
...
- [FVCOM, a regional model on an unstructured mesh](#fvcom-a-regional-model-on-an-unstructured-mesh) — NECOFS, 1978–2013 and 2025–
- [HYCOM, and bottom fields for free](#hycom-and-bottom-fields-for-free) — GOFS 3.1, 1994–2024
- [CCMP, the long wind record](#ccmp-the-long-wind-record) — six-hourly winds, 1993–present
- [MUR and VIIRS, through ERDDAP](#mur-and-viirs-through-erddap) — 0.01° satellite SST, and chlorophyll
