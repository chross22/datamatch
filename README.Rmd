...
- [Copernicus Marine](#copernicus-marine-the-widest-catalog) — `accessEnvDat()`, 1993–
...
`accessEnvDat()`. The widest catalog and the longest record: physics, biogeochemistry, satellite
...
has no bottom salinity at all and `accessEnvDat()` must derive one from the full
...
request from the single level a surface variable wants. Call `accessEnvDat()`
