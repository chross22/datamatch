...
- [FVCOM, a regional model on an unstructured mesh](#fvcom-a-regional-model-on-an-unstructured-mesh) — NECOFS on the GOM3 mesh, 1978–2013
...
- [HYCOM, and bottom fields for free](#hycom-and-bottom-fields-for-free) — GOFS 3.1, 1994–2015
...
`fvcom_archives()` names what is built in. Reading it needs the `ncdf4` package, a `Suggests`, and a
...
`expt_53.X`, 1994–2015) from the Naval Research Laboratory's THREDDS server:
