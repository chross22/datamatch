...
Two months of daily SST and SSS over a one-degree box — 59 downloads — measured
cold-cache and back to back in one session:
...
The gain scales with workers rather than with cores, because the wait is the
network: the same fetch at the default of 4 lands around 3.8×. How much you see
